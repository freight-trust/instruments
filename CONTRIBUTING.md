...
This repository uses the [Mozilla Public License 2.0](https://www.mozilla.org/en-US/MPL/2.0/)
...
Please email: [admin@freighttrust.com]
...
For small documentation changes and fixes, please provide a pull request.
...
Follow the CI/CD Procedures in the repository root
